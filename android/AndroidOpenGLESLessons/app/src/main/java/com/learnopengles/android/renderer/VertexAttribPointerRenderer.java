...
public class VertexAttribPointerRenderer<T> implements  RendererLink<T>{
    ...
    public VertexAttribPointerRenderer(Program program, AttributeVariable attributeVariable, FloatBuffer data, int dataSize) {
